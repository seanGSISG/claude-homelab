...
All scripts load credentials from `~/workspace/homelab/.env` automatically. No need to export environment variables manually.

## Troubleshooting

**"ERROR: .env file not found"**
→ Create `.env` file at `~/workspace/homelab/.env` with required variables
