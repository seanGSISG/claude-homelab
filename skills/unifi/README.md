...
All scripts load credentials from `~/.homelab-skills/.env` automatically. No need to export environment variables manually.

## Troubleshooting

**"ERROR: .env file not found"**
→ Create `.env` file at `~/.homelab-skills/.env` with required variables
