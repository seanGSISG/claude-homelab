...
→ Check your `.env` file exists at `~/.homelab-skills/.env` and contains SONARR_URL and SONARR_API_KEY
...
- Uses Sonarr API v3
- Credentials loaded from `~/.homelab-skills/.env` (NO JSON config files)
