...
Common operations for quick copy-paste usage. All scripts use credentials from `~/workspace/homelab/.env`.
...
- All scripts use credentials from `~/workspace/homelab/.env`
